...
#: Widen the window on a refusal before believing it.
...
#: 50 chunks also dilute the context more than they help, so the ladder tops out well below it.
LADDER: tuple[int, ...] = (settings.rerank_top_k, settings.ladder_top_k)
